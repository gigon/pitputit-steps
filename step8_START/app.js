...
var loadMessages = function() {
    ...
    // and call removeMessageFromHtml with the message to remove
    
    // hint: removeMessageFromHtml find the div to remove using the message.key field !
};
        ...
        imageRef.put(imageFile).then(function onComplete(snapshot) {
            ...
            snapshot.ref.getDownloadURL().then(function(downloadURL) {
                ...
                pushMessageToDb(newMessage, function(isSuccess) {
                    //-- TODO --//
                    // if saving to the Database failed, delete the image we just uploaded:
