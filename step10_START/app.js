...
function incrementUserMessageCount() {
    ...
    //-- TODO --//
    // increment the user's messageCount in a firebase transaction.
    // Warning: on the first time it's called for a user, 
    // the last messageCount would be NaN!

    // When done, set the new message count to the userMessageCount variable
    // and call updateCurrentUser() so the app will display the new count
}
